...
当前版本：**原生版 1.1.0**，支持 iOS 16 及以上。已验证的未签名 IPA、校验和与升级说明见 [1.1.0 Release](https://github.com/chengxiaomingcxm/us-stock-ledger/releases/tag/native-v1.1.0)。账本格式为 `format: 2`，也就是 1.0 起的稳定数据基线；旧 Web 版的版本号、标签和发布记录与原生版分开看。

> **English: [README.md](README.md).** 本文件是中文版。

## 演示视频

一段简短演示：示例账本（持仓、收益、每日收益日历、交易记录）、汇丰投资结单导入 —— 选择 PDF → 解析 → 导入预览 —— 以及设置。

https://github.com/user-attachments/assets/74133eae-a0a3-4f36-99aa-370a8caa8923

本演示中的所有投资组合数据及 HSBC 投资结单均为虚构示例数据，不包含任何真实客户或账户信息。
...
当前版本为 **1.1.0**。安装包、校验和和升级说明见 [GitHub Release](https://github.com/chengxiaomingcxm/us-stock-ledger/releases/tag/native-v1.1.0)，[构建记录](https://github.com/chengxiaomingcxm/us-stock-ledger/actions/runs/36215253909)与 [CHANGELOG.md](CHANGELOG.md)提供追溯。日历日期格子显示收盘浮盈，可切换金额／百分比；月收益合计每日投资盈亏（包含买卖），不累加浮盈快照。
