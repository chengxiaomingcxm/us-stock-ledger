...
个人自用的中文美股持仓账本，当前版本 **1.22（内部版本 1.22.0 / build 5）**。iOS 16 或更高版本，美元计价。

[下载 1.22 IPA、校验文件与升级说明](https://github.com/chengxiaomingcxm/us-stock-ledger/releases/tag/v1.22.0)。安装前先导出备份，使用原签名身份覆盖安装。

## 1.22 更新

“记一笔”位于底栏中央；首页说明集中到设置的离线帮助文档。首页改为浅灰背景、白色收益卡片与紧凑持仓列表，新增首页金额隐藏、筛选、排序和持仓详情。长说明集中到应用内离线帮助文档。

- [帮助文档](HELP.md)
- [1.22 升级说明](releases/v1.22.0.md)
...
新增每日收益日历、收盘累计收益曲线、个股当日贡献和重要修改前的本机恢复记录。

- [1.2 升级说明](releases/v1.2.0.md)
- [数据兼容约定](DATA-COMPATIBILITY.md)
- [收益计算与历史数据说明](DAILY-RETURNS.md)
