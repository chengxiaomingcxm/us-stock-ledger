...
- 2026-09-26 用户重新明确并授权日历口径：**每日收盘浮盈快照**（该日剩余持仓市值减剩余成本），不是每日投资收益或每日浮盈变化；月度不累加快照，显示月内最后交易日浮盈。日历明细只含当日收盘仍持仓的股票。首页每日盈亏及累计收益曲线仍使用原每日投资收益口径；详见 `DAILY-RETURNS.md`。下文旧包/旧日历记录为历史过程，不代表本次修改后的日历定义。
