...
| 18 | `e72a57b` | Help 的账本格式说明去掉「测试版 / 旧 Web 版」措辞（只留兼容边界） |
| 19 | 纯文档提交 `1017ed7` / `6ef18e9` / `本提交` | §3 词条数同步为 536、补提交表与 CI run 号；`HELP.md` / `API-SETTINGS.md` 的过时口径修正；P2 报告加历史阅读提示（`.md`-only，按 `paths-ignore` 不触发 CI） |
